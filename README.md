...
Apri il pannello e scegli **Ispeziona e salva**. Il pulsante **Seleziona** accanto al titolo attiva il puntamento in pagina: l'etichetta diventa **Clicca una sezione** e compare un overlay con guide tratteggiate, bordo arrotondato, padding e margin con i pixel su ogni lato, badge del radius, tooltip essenziale e coordinate. Passa col mouse sulle sezioni, usa le frecce del tooltip o ↑/↓ (anche dal pannello) per ampliare al contenitore padre o restringere, Invio o clic per confermare, Esc per annullare. Il clic non attiva link o pulsanti sottostanti. **Seleziona** di nuovo sostituisce la scheda precedente con una nuova ispezione.
